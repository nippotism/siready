      ...
      <div class="flex flex-col flex-1 pt-5 pb-4 overflow-y-auto">
        <div class="flex-1 px-3 space-y-1 divide-y divide-gray-200 dark:divide-gray-700">
          <ul class="pb-2 text-sm space-y-2">
            ...
            @if($user->pa == 1)
                <li>
                <a href= "/p/ajuan-irs" class="{{ $active==='ajuanIrs' ? 'bg-gray-200 dark:bg-blek-600' : '' }} flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 transition-transform hover:translate-x-1">
            ...
            @if($user->mhs == 1)
              ...
              <li>
                <button type="button" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700 transition-transform hover:translate-x-1" aria-controls="dropdown-layouts" data-collapse-toggle="dropdown-layouts">
