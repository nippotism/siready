    ...
    <div class="flex pt-12 overflow-hidde">
      ...
      <div id="main-content" class="relative w-full h-full font-poppins overflow-y-auto lg:mt-4 bg-gray-50 lg:ml-52 dark:bg-blek-900">
        ...
        <div class="mt-2 mx-14 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-blek-800">
            ...
            <div class="container-irs p-10 my-3 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-blek-500"  data-semester="{{ $item->irs_semester }}" data-email = "{{ $email }}">
      ...
      <script>
        $(document).ready(function() {
            $('.container-irs').on('click', function() {
                ...
                const semester = container.data('semester'); // Get the semester value
                const email = container.data('email');
        
                // Check if the table already exists
                const tableExists = container.closest('.p-10').find('.additional-info').length > 0;
                ...
                if (!tableExists) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            container.closest('.p-10').append(table);
                        },
                    ...
                    container.closest('.p-10').find('.additional-info').remove();
                }
            });
        });
        </script>
