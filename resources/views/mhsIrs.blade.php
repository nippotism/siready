        ...
        <div class="mt-2 mx-14 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-blek-800">
            ...
            <div class="container-irs p-10 my-3 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-blek-500">
                <div class="flex items-center justify-between">
                    ...
                    <svg class="arrow-icon -rotate-45 w-6 h-6 transition-transform duration-300 ease-in-out text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" data-semester="{{ $item->semester }}" width="24" height="24" fill="none" viewBox="0 0 24 24">
        ...
        $(document).ready(function() {
            $('.arrow-icon').on('click', function() {
                ...
                if (!tableExists) {
                    ...
                    $.ajax({
                        url: `/irs/${semester}`, // Use the semester value in the URL
                        method: 'GET',
